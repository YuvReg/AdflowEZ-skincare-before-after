...
imgs = {
    "bd": data_uri("comp-rich-before-desktop.jpg"),   # 16:9
    "ad": data_uri("comp-rich-after-desktop.jpg"),    # 16:9
    "bm": data_uri("comp-rich-before-mobile.jpg"),    # 4:5
    "am": data_uri("comp-rich-after-mobile.jpg"),     # 4:5
}
...
<title>Mosswell — Before/After slider v3 (gallery, everything in one file)</title>
<style>
  :root {{ --blue:#3B7CF4; }}
...
out = ROOT / "mosswell-slider-handoff-v3.html"
